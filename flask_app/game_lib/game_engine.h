...
void seed();
int cpu_move(short d[3][10], long n);
...
static double l1(short data[3][10], int move, long n);
static double l2(short data[3][10], int move, long n);
static double l3(short data[3][10], int move, long n);